...
class Time{
 public:
  unsigned long int SecondsNow();
  string FormatTime2Str();
  BinData FormatTime2Bin();
  string FormatTime2Str(unsigned long int Seconds);
  BinData FormatTime2Bin(unsigned long int Seconds);
