...
class ENiX_Subnet_Lean:public Permute{
 public:
  ENiX_Subnet_Lean(string Prefix,int Deps,int Mul,const Sequence& Answers, const vector<int> DepList, const int NeuralType):Permute(Prefix,Deps,Mul,Answers,DepList,NeuralType){};
 ENiX_Subnet_Lean(string Prefix,int Mul,bool Value):Permute(Prefix,Mul,Value){};
  ENiX_Subnet_Lean()=default;
  ~ENiX_Subnet_Lean(){};
