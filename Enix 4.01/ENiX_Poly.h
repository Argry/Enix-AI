...
class Poly{
 public:
  ...
  bool CreateEquation(vector<string> Seq);
  vector<double> CalculateSeq(vector<double> Input);
  double ExecutePoly(vector<double> Fx,double x);
  void SetEquation(vector<double> Eq);
  string GetFormula();
